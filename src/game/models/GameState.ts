...
import { Position, Phase, Team, GameSettings, TeamScore, type PlayerId, type RoundId } from './Types'
export class GameState {
  ...
  private checkGameEnd(): void {
    for (const [team, teamScore] of this.teamScores) {
      if (teamScore.hasWon(this.settings.targetScore)) {
